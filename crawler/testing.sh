...
echo "2) Letters Depths 0,1,2,3"
mkdir -p "$DATA/letters-0" "$DATA/letters-1" "$DATA/letters-2" "$DATA/letters-3"
...
echo "4) Toscrape Depths 0, 1, 2"
mkdir -p "$DATA/toscrape-0" "$DATA/toscrape-1" "$DATA/toscrape-2"
$PROG "$SEED_BASE/toscrape/index.html" "$DATA/toscrape-0" 0
$PROG "$SEED_BASE/toscrape/index.html" "$DATA/toscrape-1" 1
$PROG "$SEED_BASE/toscrape/index.html" "$DATA/toscrape-2" 2
